...
export function SettingsControl() {
  ...
  return (
    ...
    <div className="card">
      <div className="card-header"><div><h2 className="section-title">Shopify connection</h2><p className="section-desc">Install this custom-distribution app once to store an encrypted offline token for unattended syncs.</p></div></div>
      <div className="card-body"><a className="btn btn-primary" href="/api/shopify/install"><Link2 size={15} />Connect Shopify store</a></div>
    </div>
    <div className="card">
